...
exports.postCustomer = async (req, res) => {
  ...
  const newCustomer = new Customer({
    ...
    // ---------------
    redBloodCellCount: req.body.redBloodCellCount,
    hemoglobin: req.body.hemoglobin,
    hematocrit: req.body.hematocrit,
    meanCorpuscularVolume: req.body.meanCorpuscularVolume,
    meanCorpuscularHemoglobin: req.body.meanCorpuscularHemoglobin,
    meanCorpuscularHemoglobinConcentration:
      req.body.meanCorpuscularHemoglobinConcentration,
    whiteBloodCellCount: req.body.whiteBloodCellCount,
